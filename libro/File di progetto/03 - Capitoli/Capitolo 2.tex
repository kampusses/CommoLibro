...
qualsiasi cosa, vogliamo sapere in quale condizione si trova lo schermo sul quale lavoreremo. Le prime istruzioni
...
CHR\$ è una funzione del BASIC. Riceve un numero compreso tra 0 e 255 e restituisce il carattere associato a quel
...
non stampa quindi il disegno corrispondente al numero 147. Invia al sistema il codice \textbf{CLR/HOME}, che pulisce lo
schermo e riporta il cursore nella posizione iniziale. 
...
La tabella completa comprende tutti i valori da 0 a 255 e contiene, oltre ai codici di controllo, lettere, numeri,
punteggiatura e numerosi simboli grafici. Troveremo la raccolta integrale nell$\text{\textgreek{’}}$appendice dedicata,
dove potrà essere utilizzata come strumento di consultazione.
...
30 print c;chr\$(c);{\textquotedbl} \ {\textquotedbl};
...
chiedere al Commodore di ripetere le righe comprese fra 20 e 40 utilizzando valori successivi di C.
...
Quando avremo finito, sappiamo già come ripulire tutto:
