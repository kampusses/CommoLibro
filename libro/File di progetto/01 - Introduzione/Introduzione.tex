...
Non sapevo ancora che la risposta sarebbe arrivata due anni dopo, grazie un professore illuminante e a un computer che
portava un numero apparentemente insignificante.

Sessantaquattro.

Quel computer entrò nella mia vita quando ero ancora un ragazzino e, quasi senza accorgermene, cambiò il modo in cui
...
Una conoscenza di base della programmazione BASIC e dell$\text{\textgreek{’}}$Assembly renderà certamente il percorso
più agevole. Sapere che cosa siano una variabile, un$\text{\textgreek{’}}$istruzione, una condizione o un ciclo
permetterà di concentrarsi più rapidamente sui problemi che incontreremo durante la costruzione del gioco. Non è però
un prerequisito indispensabile e, soprattutto, non sarà necessario conoscere già il BASIC del Commodore 64 in tutti i
suoi dettagli.

Chi parte da più lontano, oppure ha semplicemente lasciato trascorrere molti anni dall$\text{\textgreek{’}}$ultima volta
che ha scritto una riga di BASIC, potrà fare riferimento all$\text{\textgreek{’}}$Appendice A, dove vengono presentate
e spiegate le parole chiave del BASIC del Commodore 64. Nel corso del libro, inoltre, Esperimenti e Laboratori
offriranno continuamente l$\text{\textgreek{’}}$occasione di fermarsi, provare direttamente ciò che abbiamo appena
incontrato e consolidare i concetti prima di utilizzarli nel progetto.

Non sarà quindi necessario studiare prima il linguaggio e soltanto dopo iniziare a costruire il gioco. Procederemo nella
direzione opposta: sarà il gioco stesso a far emergere, volta per volta, ciò che abbiamo bisogno di conoscere. Quando
incontreremo un$\text{\textgreek{’}}$istruzione nuova ci fermeremo quanto basta per comprenderne il ruolo; quando un
concetto richiederà di essere osservato direttamente, lo sperimenteremo; quando sarà utile mettere insieme più
conoscenze, lo faremo in laboratorio.

In questo modo anche chi possiede già una certa familiarità con il BASIC potrà proseguire senza essere costretto ad
attraversare un corso introduttivo completo, mentre chi ha bisogno di qualche sostegno in più avrà sempre a
disposizione gli strumenti necessari per non perdere il filo del percorso.
...
imparare a osservare un problema, formulare un'ipotesi e verificare se quell'idea sia davvero in grado di funzionare.
...
cercando un equilibrio tra il racconto di una storia personale e la costruzione di un vero percorso di apprendimento.
